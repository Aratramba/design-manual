...
"use strict";function onNavLinkClick(e){var t=e.delegateTarget.getAttribute("href"),s=document.querySelector(t).offsetTop;window.scrollTo(0,s),history.pushState(null,null,t),document.getElementById("hamburger").checked=!1,e.preventDefault()}function setActive(e){for(var t,s=0,n=$navLinks.length;s<n;s++)t=$navLinks[s],t.getAttribute("data-rel")===e.section?t.classList.add(constants.ACTIVE_CLASS):t.classList.remove(constants.ACTIVE_CLASS)}var delegate=require("delegate-events"),dispatcher=require("./dispatcher"),constants=require("../constants"),$sidebar=document.querySelector(".js-sidebar"),$navLinks=document.querySelectorAll(".js-sidebar__item");$sidebar&&delegate.bind($sidebar,".js-sidebar__item a","click",onNavLinkClick),dispatcher.on(constants.EVENT_SECTION_INVIEW,setActive);
