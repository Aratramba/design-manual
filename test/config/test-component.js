...
test.cb('config: component change', t => {
  ...
  buildAndMatchLogs(null, Object.assign(config, { components: './test/components.json' }), null, () => {
    buildAndMatchLogs(t, Object.assign(config, { components: './test/components2.json' }), expected);
  });
});