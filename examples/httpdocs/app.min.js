...
"use strict";function onToggle(e){var t=e.target.parentNode.parentNode,r=t.querySelector("pre code"),n=t.querySelector("iframe"),o=n.contentWindow.document.body.querySelector(".js-output").innerHTML;r.innerHTML=Prism.highlight(prettyPrint(o),Prism.languages.markup)}var LazyLoad=require("vanilla-lazyload"),Prism=require("../libs/prism"),iframeResizer=require("../libs/iframeResizer.min"),delegate=require("delegate-events"),prettyPrint=require("html").prettyPrint,interact=require("interact.js"),constants=require("../constants");document.querySelectorAll(".table-of-contents__list").length&&(document.body.classList.add(constants.LOADING_CLASS),new LazyLoad({threshold:100,elements_selector:"iframe",callback_load:function(e){e.parentNode.parentNode.classList.remove("is-loading")},callback_error:function(e){$el.parentNode.parentNode.classList.remove("has-error")}}),iframeResizer({checkOrigin:!1}),delegate.bind(document.body,".table-of-contents__list__item__link","click",function(e){var t=e.delegateTarget.getAttribute("href"),r=document.querySelector(t).offsetTop;window.scrollTo(0,r),history.pushState(null,null,t),e.preventDefault()}),document.body.classList.remove(constants.LOADING_CLASS),delegate.bind(document.body,".js-code-toggle","click",onToggle),interact(".js-component-preview").resizable({edges:{left:!1,right:".js-component-preview-handle",bottom:!1,top:!1},onmove:function(e){e.target.style.width=e.rect.width+"px",e.target.classList.add(constants.RESIZING_CLASS),e.target.querySelector("iframe").contentWindow.parentIFrame.size()},onend:function(e){e.target.classList.remove(constants.RESIZING_CLASS)}}));

},{"../constants":12,"../libs/iframeResizer.min":14,"../libs/prism":15,"delegate-events":4,"html":5,"interact.js":6,"vanilla-lazyload":10}],12:[function(require,module,exports){
"use strict";var constants={EVENT_SECTION_INVIEW:"section-in-view",LOADING_CLASS:"is-loading",ACTIVE_CLASS:"is-active",SIDEBAR_EMPTY_CLASS:"sidebar-is-empty",RESIZING_CLASS:"is-resizing"};module.exports=constants;
...
},{"./components/index":11,"./main/breadcrumb":16,"./main/offcanvas":18,"./main/section":19,"./main/sidebar":20}],14:[function(require,module,exports){
...
},{"../constants":12,"./dispatcher":17}],17:[function(require,module,exports){
...
},{"events":1,"object-assign":9}],18:[function(require,module,exports){
...
},{"../constants":12,"./dispatcher":17}],20:[function(require,module,exports){
"use strict";function init(){render(aggregate())}function aggregate(){for(var e,t={},n=document.querySelectorAll(".content h2"),r=0,i=n.length;r<i;++r)(e=n[r].id)&&(t[n[r].id]={label:n[r].textContent,id:e});return Object.keys(t).map(function(e){return t[e]})}function render(e){var t=Mustache.render(TEMPLATE,{items:e});$sidebar.innerHTML=t,e.length>1&&document.body.classList.remove(constants.SIDEBAR_EMPTY_CLASS),$navLinks=document.querySelectorAll(".js-sidebar__item"),delegate.bind($sidebar,".js-sidebar__item a","click",onNavLinkClick)}function onNavLinkClick(e){var t=e.delegateTarget.getAttribute("href"),n=document.querySelector(t).offsetTop;window.scrollTo(0,n),history.pushState(null,null,t),document.getElementById("hamburger").checked=!1,e.preventDefault()}function setActive(e){for(var t,n=0,r=$navLinks.length;n<r;n++)t=$navLinks[n],t.classList.toggle(constants.ACTIVE_CLASS,t.getAttribute("data-rel")===e.section)}var delegate=require("delegate-events"),Mustache=require("mustache"),dispatcher=require("./dispatcher"),constants=require("../constants"),TEMPLATE=document.getElementById("sidebar-link-template").innerHTML;Mustache.parse(TEMPLATE);var $sidebar=document.querySelector(".js-sidebar"),$navLinks;dispatcher.on(constants.EVENT_SECTION_INVIEW,setActive),$sidebar&&init();

},{"../constants":12,"./dispatcher":17,"delegate-events":4,"mustache":8}]},{},[13]);
