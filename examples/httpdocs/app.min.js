...
"use strict";window.App={},require("./main/sidebar"),require("./components/index"),require("./main/breadcrumb"),require("./main/section");
},{"./components/index":10,"./main/breadcrumb":15,"./main/section":17,"./main/sidebar":18}],13:[function(require,module,exports){
...
},{"../constants":11,"./dispatcher":16}],16:[function(require,module,exports){
...
},{"events":1,"object-assign":8}],17:[function(require,module,exports){
...
},{"../constants":11,"./dispatcher":16}],18:[function(require,module,exports){
"use strict";function scrollWithOffset(e){var t=document.querySelector(e);if(t){var n=t.getBoundingClientRect().top,c=document.querySelector(".header");c&&(n-=c.getBoundingClientRect().height),window.scrollBy(0,n-20)}}function onLinkClick(e){var t=e.delegateTarget.getAttribute("href");t&&document.querySelector(t)&&(e.preventDefault(),scrollWithOffset(t),history.replaceState(null,null,t),document.getElementById("hamburger").checked=!1)}function setActive(e){for(var t,n=0,c=$navLinks.length;n<c;n++)t=$navLinks[n],t.getAttribute("data-rel")===e.section?t.classList.add(constants.ACTIVE_CLASS):t.classList.remove(constants.ACTIVE_CLASS)}var delegate=require("delegate-events"),dispatcher=require("./dispatcher"),constants=require("../constants"),$sidebar=document.querySelector(".js-sidebar"),$navLinks=document.querySelectorAll(".js-sidebar__item");delegate.bind(document.body,"a","click",onLinkClick),location.hash&&(console.log(location.hash),setTimeout(function(){scrollWithOffset(location.hash)},0)),dispatcher.on(constants.EVENT_SECTION_INVIEW,setActive);

},{"../constants":11,"./dispatcher":16,"delegate-events":4}]},{},[12]);
