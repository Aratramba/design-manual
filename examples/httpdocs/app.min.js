...
"use strict";function onToggle(e){var t=e.target.parentNode.parentNode,n=t.querySelector("pre code"),r=t.querySelector("iframe"),o=r.contentWindow.document.body.querySelector(".dm-raw-source").innerHTML;n.innerHTML=window.Prism.highlight(prettyPrint(o),window.Prism.languages.markup)}var delegate=require("delegate-events"),prettyPrint=require("html").prettyPrint,interact=require("interactjs/dist/interact.min"),constants=require("../constants");document.body.classList.add(constants.LOADING_CLASS),new window.LazyLoad({threshold:200,elements_selector:"iframe",callback_load:function(e){e.parentNode.parentNode.classList.remove("is-loading")},callback_error:function(e){e.parentNode.parentNode.classList.remove("has-error")}}),window.iFrameResize({checkOrigin:!1}),delegate.bind(document.body,".table-of-contents__list__item__link","click",function(e){var t=e.delegateTarget.getAttribute("href"),n=document.querySelector(t).offsetTop;window.scrollTo(0,n),history.pushState(null,null,t),e.preventDefault()}),document.body.classList.remove(constants.LOADING_CLASS),delegate.bind(document.body,".js-code-toggle","click",onToggle),interact(".js-component-preview").resizable({edges:{left:!1,right:".js-component-preview-handle",bottom:!1,top:!1},onmove:function(e){e.target.style.width=e.rect.width+"px",e.target.classList.add(constants.RESIZING_CLASS),e.target.querySelector("iframe").contentWindow.parentIFrame.size()},onend:function(e){e.target.classList.remove(constants.RESIZING_CLASS)}});

},{"../constants":10,"delegate-events":4,"html":5,"interactjs/dist/interact.min":6}],10:[function(require,module,exports){
...
"use strict";window.App={},require("./main/sidebar"),require("./components/index"),require("./main/breadcrumb"),require("./main/section"),require("./main/anchors"),window.Prism.highlightAll();
},{"./components/index":9,"./main/anchors":12,"./main/breadcrumb":13,"./main/section":15,"./main/sidebar":16}],12:[function(require,module,exports){
...
},{"delegate-events":4}],13:[function(require,module,exports){
...
},{"../constants":10,"./dispatcher":14}],14:[function(require,module,exports){
...
},{"events":1,"object-assign":8}],15:[function(require,module,exports){
...
},{"../constants":10,"./dispatcher":14}],16:[function(require,module,exports){
