...
"use strict";function init(){render(aggregate())}function aggregate(){for(var e,t={},n=document.querySelectorAll(".content h2"),r=0,a=n.length;r<a;++r)(e=n[r].id)&&(t[n[r].id]={label:n[r].textContent,id:e});return Object.keys(t).map(function(e){return t[e]})}function render(e){var t=Mustache.render(TEMPLATE,{items:e});$sidebar.innerHTML=t,e.length>1&&document.body.classList.remove(constants.SIDEBAR_EMPTY_CLASS),$navLinks=document.querySelectorAll(".js-sidebar__item"),delegate.bind($sidebar,".js-sidebar__item a","click",onNavLinkClick)}function onNavLinkClick(e){var t=e.delegateTarget.getAttribute("href"),n=document.querySelector(t).offsetTop;window.scrollTo(0,n),history.pushState(null,null,t),document.getElementById("hamburger").checked=!1,e.preventDefault()}function setActive(e){for(var t,n=0,r=$navLinks.length;n<r;n++)t=$navLinks[n],t.getAttribute("data-rel")===e.section?t.classList.add(constants.ACTIVE_CLASS):t.classList.remove(constants.ACTIVE_CLASS)}var delegate=require("delegate-events"),Mustache=require("mustache"),dispatcher=require("./dispatcher"),constants=require("../constants"),TEMPLATE=document.getElementById("sidebar-link-template").innerHTML;Mustache.parse(TEMPLATE);var $sidebar=document.querySelector(".js-sidebar"),$navLinks;dispatcher.on(constants.EVENT_SECTION_INVIEW,setActive),$sidebar&&init();
