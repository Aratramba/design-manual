...
"use strict";function onToggle(e){var t=e.target.parentNode.parentNode,r=t.querySelector("pre code"),n=t.querySelector("iframe"),o=n.contentWindow.document.body.querySelector(".dm-raw-source").innerHTML;r.innerHTML=Prism.highlight(prettyPrint(o),Prism.languages.markup)}var LazyLoad=require("vanilla-lazyload"),Prism=require("../libs/prism"),iframeResizer=require("../libs/iframeResizer.min"),delegate=require("delegate-events"),prettyPrint=require("html").prettyPrint,interact=require("interact.js"),constants=require("../constants");document.body.classList.add(constants.LOADING_CLASS),new LazyLoad({threshold:100,elements_selector:"iframe",callback_load:function(e){e.parentNode.parentNode.classList.remove("is-loading")},callback_error:function(e){e.parentNode.parentNode.classList.remove("has-error")}}),iframeResizer({checkOrigin:!1}),delegate.bind(document.body,".table-of-contents__list__item__link","click",function(e){var t=e.delegateTarget.getAttribute("href"),r=document.querySelector(t).offsetTop;window.scrollTo(0,r),history.pushState(null,null,t),e.preventDefault()}),document.body.classList.remove(constants.LOADING_CLASS),delegate.bind(document.body,".js-code-toggle","click",onToggle),interact(".js-component-preview").resizable({edges:{left:!1,right:".js-component-preview-handle",bottom:!1,top:!1},onmove:function(e){e.target.style.width=e.rect.width+"px",e.target.classList.add(constants.RESIZING_CLASS),e.target.querySelector("iframe").contentWindow.parentIFrame.size()},onend:function(e){e.target.classList.remove(constants.RESIZING_CLASS)}});

},{"../constants":11,"../libs/iframeResizer.min":13,"../libs/prism":14,"delegate-events":4,"html":5,"interact.js":6,"vanilla-lazyload":9}],11:[function(require,module,exports){
"use strict";var constants={EVENT_SECTION_INVIEW:"section-in-view",LOADING_CLASS:"is-loading",ACTIVE_CLASS:"is-active",RESIZING_CLASS:"is-resizing"};module.exports=constants;

},{}],12:[function(require,module,exports){
"use strict";window.App={},require("./main/sidebar"),require("./components/index"),require("./main/breadcrumb"),require("./main/section"),require("./main/anchors");var Prism=require("./libs/prism");window.Prism.highlightAll();
},{"./components/index":10,"./libs/prism":14,"./main/anchors":15,"./main/breadcrumb":16,"./main/section":18,"./main/sidebar":19}],13:[function(require,module,exports){
...
},{"../constants":11,"./dispatcher":17}],17:[function(require,module,exports){
...
},{"events":1,"object-assign":8}],18:[function(require,module,exports){
...
},{"../constants":11,"./dispatcher":17}],19:[function(require,module,exports){
"use strict";function setActive(t){for(var s,e=0,n=$navLinks.length;e<n;e++)s=$navLinks[e],s.getAttribute("data-rel")===t.section?s.classList.add(constants.ACTIVE_CLASS):s.classList.remove(constants.ACTIVE_CLASS)}var dispatcher=require("./dispatcher"),constants=require("../constants"),$navLinks=document.querySelectorAll(".js-sidebar__item");dispatcher.on(constants.EVENT_SECTION_INVIEW,setActive);

},{"../constants":11,"./dispatcher":17}]},{},[12]);
