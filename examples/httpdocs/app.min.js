...
"use strict";function onLinkClick(e){var t=e.delegateTarget.getAttribute("href");if(t&&document.querySelector(t)){e.preventDefault();var n=document.querySelector(t).getBoundingClientRect().top,r=document.querySelector(".header");r&&(n-=r.getBoundingClientRect().height),window.scrollBy(0,n-20),history.replaceState(null,null,t),document.getElementById("hamburger").checked=!1}}function setActive(e){for(var t,n=0,r=$navLinks.length;n<r;n++)t=$navLinks[n],t.getAttribute("data-rel")===e.section?t.classList.add(constants.ACTIVE_CLASS):t.classList.remove(constants.ACTIVE_CLASS)}var delegate=require("delegate-events"),dispatcher=require("./dispatcher"),constants=require("../constants"),$sidebar=document.querySelector(".js-sidebar"),$navLinks=document.querySelectorAll(".js-sidebar__item");delegate.bind(document.body,"a","click",onLinkClick),dispatcher.on(constants.EVENT_SECTION_INVIEW,setActive);
