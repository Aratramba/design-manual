...
function build(config) {
  ...
  let options = Object.assign({
    ...
    componentMeta: {
      browsers: [
        { name: 'edge', icon: 'https://cdnjs.cloudflare.com/ajax/libs/browser-logos/45.6.0/edge/edge_16x16.png' },
        { name: 'firefox', icon: 'https://cdnjs.cloudflare.com/ajax/libs/browser-logos/45.6.0/firefox/firefox_16x16.png' }
      ]
    },
